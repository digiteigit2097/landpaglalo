...
import { criarCategoria, type EstadoAcao } from "@/app/admin/(painel)/catalogo/actions";

const inicial: EstadoAcao = {};

export default function NovaCategoriaForm() {
  const [estado, formAction, pendente] = useActionState(criarCategoria, inicial);
  ...
  return (
    ...
    >
      ...
      >
        {pendente ? "Criando..." : "Adicionar categoria"}
      </button>
      {estado.erro && (
